...
**Launch:** Dashboard → **Messages → Session vault**. This entry is intentionally **not** on the Live screen or Apps menu.

**Return:** Tap **← Dashboard** (top-left) on the PIN screen or inside the app to go back to the main dashboard.
...
- Body scrolls; **← Dashboard** returns to `../` (dashboard home)
